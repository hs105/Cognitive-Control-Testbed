...
%                 reward_abs = 1/abs(log(predicted Entropy(count)));
                ...
                % learing from prediction
                agent2 = agent2.dp(1,1,i,predictedReward2(i)); % there is only one state (1)
            end
        ...
        % learning by Q-learning method
        agent2 = agent2.dp(1,1,idx,reward2(k)); % there is only one state (1)
...
semilogy(1:N,meanEntropy2,'k','linewidth',2)
hold on
